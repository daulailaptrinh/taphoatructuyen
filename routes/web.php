...
Route::get('thong-tin-tai-khoan', 'MyAccount@index')->name('myaccount.index');
Route::post('thong-tin-tai-khoan', 'MyAccount@show')->name('myaccount.store');
Route::get('thong-tin-tai-khoan/{id}', 'MyAccount@show')->name('myaccount.show');
...
Route::middleware('CheckLevel')->group(function () {
    ...
    Route::get('phieunhap', 'ImportController@index')->name('import.index');
    Route::get('phieunhap/create', 'ImportController@create')->name('import.create');
    Route::post('phieunhap/store', 'ImportController@store')->name('import.store');
    Route::put('phieunhap/update/{id}', 'ImportController@update')->name('import.update');
    Route::delete('phieunhap/delete/{id}', 'ImportController@destroy')->name('import.destroy');
    Route::get('phieunhap/{id}/edit', 'ImportController@edit')->name('import.edit');
    Route::get('phieunhap/{id}', 'ImportController@show')->name('import.show');
});