                        ...
                        <table>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <input style="width: 25%; text-align: center;" type="number"  value="{{$cart['qty']}}" min="1"  oninput="this.value = Math.abs(this.value)" name="qtycart" readonly/></td>
                                    <!-- <td class="product-subtotal">{{ trans('home.INSTOCK') }}</td> -->
                                     <td class="product-subtotal">{{ $cart['item']['product_quantity'] }}</td>
