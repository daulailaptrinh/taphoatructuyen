                ...
                <div class="sidebar">
                    ...
                    <div class="search-filter mb-40">
                        ...
                        <form class="sidbar-style">
                            ...
                            <input type="submit" name="filter_price" class="btn btn-default" value="Lọc">
                        </form>
                    </div>
                            ...
                            <div class="side-pro-item">
                                ...
                                <div class="single-product single-product-sidebar">
                                    ...
                                    <div class="pro-img">
                                        ...
                                        @if($new_pr->promotion_price != 0 && $new_pr->unit_price != 0)
                                    ...
                                    <div class="single-product">
                                        ...
                                        <div class="pro-content">
                                            <div class="pro-info">
                                                ...
                                                @if($seach_pro->promotion_price != 0 && $seach_pro->unit_price != 0)
