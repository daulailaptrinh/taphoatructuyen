...
<div class="popup_wrapper">
    <div class="test">
        ...
        <div class="subscribe_area text-center mt-60">
            <h2>Bản Tin</h2>
            <p>Đăng ký thành viên để nhận thông tin cập nhật về hàng mới, ưu đãi đặc biệt và thông tin giảm giá khác.</p>
        ...
        <div class="container">
            ...
            <div class="header-top">
                ...
                <ul>
                    ...
                    <li>
                        <a href="{{ route('myaccount.index') }}"><i class="far fa-id-card"></i> {{ trans('home.hi') }},
            ...
            <div class="row align-items-center no-gutters">
                <div class="col-lg-3 col-md-12">
                    <div class="logo mb-all-30">
                        <a href="{{route('trang-chu')}}"><img src="{{asset('source/assets/dest/images/logo.png')}}" style="width: 214px; height: 162px" alt="logo-image"></a>
                    </div>
                </div>
            ...
            <nav>
                <div id="cate-mobile-toggle" class="category-menu sidebar-menu sidbar-style mobile-categorei-menu-list menu-hidden ">
                    <ul>
                        ...
                        <li class="has-sub"><a href="{{route('loaisanpham',$sl->id)}}"> {{$sl->name_type}}</a></li>
                        @endforeach
                    </ul>
                </div>
                <!-- category-menu-end -->
