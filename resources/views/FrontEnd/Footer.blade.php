    ...
    <div class="footer-top">
        <div class="container">
            ...
            <div class="row">
                    ...
                    <div class="single-footer mb-sm-40">
                        ...
                        <div class="footer-content">
                            <ul class="footer-list">
                                ...
                                <li><a href="lien-he">Điều khoản và điều kiện</a></li>
                                <li><a href="{{route('dangnhap')}}">Câu hỏi thường gặp</a></li>
                                <li><a href="{{route('dangnhap')}}">Chính sách hoàn trả</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-2 col-md-4 col-sm-6">
                    <div class="single-footer mb-sm-40">
                        <h3 class="footer-title">Tiện Ích Bổ Sung</h3>
                        <div class="footer-content">
                            <ul class="footer-list">
                ...
                <div class="col-lg-2 col-md-4 col-sm-6">
                    <div class="single-footer mb-sm-40">
                        ...
                        <div class="footer-content">
                            <ul class="footer-list">
                                <li><a href="{{route('lienhe')}}">Liên Hệ Chúng Tôi</a></li>
                ...
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="single-footer mb-sm-40">
                        <h3 class="footer-title">Liện Hệ Tôi</h3>
                        <div class="footer-content">
                            <ul class="footer-list address-content">
                                <li><i class="lnr lnr-map-marker"></i><b>Địa Chỉ:</b> Đại Học Cần Thơ, Đường 3/2 Phường
                                    An Khánh Quận Ninh Kiều TP Cần Thơ
                                </li>
                                <li><i class="lnr lnr-envelope"></i><a href="mailto:npn020899@gmail.com"><b>Gmail:</b>
                                        daub1910508@gmail.com</a>
                                </li>
                                <li>
                                    <i class="lnr lnr-phone-handset"></i><a href="tel:+84773654031"><b>Phone:</b>
                                        0945275090
                                    </a>
                                </li>
                            </ul>
                            <div class="payment mt-25 bdr-top pt-30">
                                <a href="#"><img class="img" src="{{asset('source/assets/frontend/img/payment/1.png')}}"
                                        alt="payment-image"></a>
                            </div>
                        </div>
                    </div>
        ...
        <div class="container">
            <div class="footer-middle-content pt-20 pb-30">
                <div class="social-footer">
                    <a href="https://www.facebook.com/hoangdauPK/"><i class="fa fa-facebook"></i></a>
                    <a href="https://twitter.com/"><i class="fa fa-twitter"></i></a>
                    <a href="https://mail.google.com/mail/u/2/?ogbl#inbox"><i class="fa fa-google-plus"></i></a>
                    <a href="https://www.youtube.com/@TFTUltraDeveloper"><i class="fa fa-youtube"></i></a>
    ...
    <div class="footer-bottom pb-30">
        <div class="container">
            ...
            <div class="copyright-text text-center">
                <p>Copyright © 2023 <a target="_blank" href="#"></a>Bản quyền thuộc VinChoice</p>
            </div>
        </div>
        <!-- Container End -->
    </div>
                            ...
                            <div class="col-lg-5 col-md-6 col-sm-5">
                                ...
                                <div class="tab-content">
                                    <div id="thumb1_{{$all->id}}" class="tab-pane fade show active">
                                        <a data-fancybox="images" href="source/image/product/{{$all->image}}"><img
                                ...
                                <div class="product-thumbnail mt-20">
                                    <div class="thumb-menu owl-carousel nav tabs-area" role="tablist">
                                        <a class="active" data-toggle="tab" href="#thumb1_{{$all->id}}"><img
                                                src="source/image/product/{{$all->image}}" alt="product-thumbnail"
                                                height="98.55px" width="98.55px"></a>
                                    </div>
                                </div>
                                <!-- Thumbnail image end -->
                            </div>
                                ...
                                <div class="thubnail-desc fix mt-sm-40">
                                    ...
                                    <div class="pro-price mtb-30">
                                        <p class="d-flex align-items-center">
                                            @if($all->promotion_price != 0 && $all->unit_price != 0)
                                            <span class="prev-price">{{number_format($all->unit_price,0,',','.')}}
                                                VNĐ</span>
                                            <span class="price">{{number_format($all->promotion_price,0,',','.')}}
                                                VNĐ</span>
                    ...
                    <div class="custom-footer">
                        <div class="socila-sharing">
                            <ul class="d-flex">
                                ...
                                <li><a class="share" href="https://plus.google.com/share?url={{$url_canonical}}"><i
