                                ...
                                <td>{{ $dh->note }}</td> -->
                                 ...
                                 <td>
                                     ...
                                     <button class="btn btn-outline-danger delete" data-toggle="modal"
                                         data-target="#dhchuaduyetDel_{{ $dh->id_bill }}" type="button"><i
                                             class="fas fa-trash-alt"></i></button>
                                     <!-- </a> -->
                                 </td>

                                 <!-- Modal Delete-->
                                 <div class="modal fade" id="dhchuaduyetDel_{{ $dh->id_bill }}" tabindex="-1"
                                     ...
                                     <div class="modal-dialog" role="document">
                                         <div class="modal-content">
                                             ...
                                             <div class="modal-body">Chọn "Delete" bên dưới nếu bạn đã chắc chắn muốn xóa.
                                             </div>
