                  ...
                  <tbody>
                    ...
                    <tr class="color_qty_{{$bd->id_product}}">
                      ...
                      <td>
                        ...
                        @csrf
                          <input class="order_qty_{{$bd->id_product }}" type="number" readonly name="product_quantity_order" value="{{$bd->quantity}}" min="1" {{$dh_ct->status_bill != 0 ? 'disabled' : ''}}  style="width: 40px; text-align: center;">
