...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        @if (Session::get('gallery_session'))
                            <a class="collapse-item {{ Request::url() == route('gallelyedit', Session::get('gallery_session')) ? 'active' : '' }}"
                                href="">{{ trans('home_ad.ql_gallery') }}</a>
                        @endif
                    </div>
                </div>
            </li>
            ...
            <!-- Nav Item - Tables -->
            <li class="nav-item {{ request()->is('phieunhap*') ? 'active' : '' }}">
                ...
                <div id="collapseImport"
                    class="collapse {{ request()->is('phieunhap*') ? 'show' : '' }}">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Phiếu nhập:</h6>
                        <a class="collapse-item {{ request()->url() == route('import.index') ? 'active' : '' }}"
                            href="{{ route('import.index') }}">Danh sách
                        </a>
                        @if (request()->is('phieunhap/*'))
                        <a class="collapse-item {{ request()->is('phieunhap/*') ? 'active' : '' }}"
                            href="{{ request()->url() }}">Chi tiết phiếu nhập
                        </a>
                        @endif
        ...
        <script type="text/javascript">
            $(document).ready(function() {
                ...
                Morris.Donut({
                    ...
                    data: [{
                            label: "{{ trans('home_ad.dash_sp') }}",
                            value: <?php echo $sp_count; ?>
                        },
                        {
                            label: "{{ trans('home_ad.dash_dn') }}",
                            value: <?php echo $dh_count; ?>
                        },
                        {
                            label: "{{ trans('home_ad.dash_kh') }}",
                            value: <?php echo $nd_count; ?>
                        },
                        {
                            label: "{{ trans('home_ad.dash_lang') }}",
                            value: 2
                        },
                        {
                            label: "{{ trans('home_ad.dash_nsx') }}",
                            value: <?php echo $loai_count; ?>
                        },
                        {
                            label: "Slide",
                            value: <?php echo $slide_count; ?>
                        }
                    ]
                });
