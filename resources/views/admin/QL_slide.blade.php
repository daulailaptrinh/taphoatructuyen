                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <?php
                                    ...
                                    ?>
                            <a href="{{url('/unactive-slide/'.$sl->id)}}"><span style="color: #e74a3b;"
                        ...
                        <!-- Modal Delete-->
                        <div class="modal fade" id="slideDel_{{$sl->id}}" tabindex="-1" role="dialog"
                        ...
                        <!-- Modal Update-->
                        <div class="modal fade" id="slideUpdate_{{$sl->id}}" tabindex="-1" role="dialog"
                            ...
                            <div class="modal-dialog modal-lg" role="document">
                                <div class="modal-content">
                                    ...
                                    <form action="{{route('update_slide', $sl->id )}}" method="post"
                                        enctype="multipart/form-data">
                                        <input type="hidden" name="_token" value="{{csrf_token()}}">
                                        <div class="modal-body">
                                            <div class="form-group">
                                                <label style="font-weight: bold; color: #000">Tên Quản Cáo</label>
                                                <input type="text" id="e_link_{{$sl->id}}" name="link_slide"
                                                    class="form-control" value="{{$sl->link}}" />

                                            </div>
                                            <div class="form-group" style="font-weight: bold; color: #000">
                                                <label
                                                    style="font-weight: bold; color: #000">{{ trans('Ql_sp.trangthai') }}</label>
                                                <select name="status_slide" class="form-control">
                                                    <option value="0" <?php if($sl->status_slide==0)echo 'selected' ?>>
                                                        Hiển Thị</option>
                                                    <option value="1" <?php if($sl->status_slide==1)echo 'selected' ?>>
                                                        Ẩn</option>
                                                </select>
                                            </div>
                                            <div class="form-group">
                                                <label
                                                    style="font-weight: bold; color: #000">{{ trans('Ql_sp.hinhanh') }}</label>
                                                <input type="file" id="e_image_{{$sl->id}}" name="image"
...
<!-- Modal Add-->
<div class="modal fade" id="slideAdd" tabindex="-1" role="dialog" style="z-index: 1050; display: none;"
    aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header text-write">
