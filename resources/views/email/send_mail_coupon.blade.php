...
<body>
    <div class="coupon">
        <div class="container">
            <h3>Mã khuyến mãi từ shop <a href="http://127.0.0.1:8000/" target="_blank">VinChoice.vn</a></h3>
        </div>
        ...
        <div class="container">
            <p class="code">Sừ dụng Code sau: <span
                    class="promo">{{$coupon_array['coupon_send_new']['coupon_code']}}</span></p>
