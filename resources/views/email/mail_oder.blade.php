        ...
        <div id="wrapper" style="background-color:#f0f0f0">
            <table align="center" border="0" cellpadding="0" cellspacing="0" width="600"
                ...
                <tbody>
                                ...
                                <tbody>
                                    <tr>
                                        <td align="left" valign="middle" style="width:500px;height:60px">
                                            <a href="{{route('trang-chu')}}" style="border:0" target="_blank"
                                                width="130" height="35" style="display:block;border:0px">
                                                <img src="https://f22-zfcloud.zdn.vn/163b950a2175c02b9964/2163659212552015478"
                                                    height="110px" width="155px"
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td align="left" valign="middle"
                                            ...
                                            <br> Cảm ơn bạn đã mua sắm tại VinChoice
                                            <br>
                                            <br> Đơn hàng của bạn đang
                                            <b>chờ soạn hàng</b>
                                            <b>xác nhận</b> (trong vòng 24h)
                                            <br> Chúng tôi sẽ thông tin <b>trạng thái đơn hàng</b> trong email tiếp
                                            theo.
                    ...
                    <tr>
                        <td align="center" valign="middle" style="background:#ffffff">
                            <table style="width:580px;border:1px solid #ff3333;border-top:3px solid #ff3333"
                                    ...
                                    <tr>
                                        <!-- <td align="left" valign="top" style="width:120px;padding-left:15px">
                                            <a href="#_" style="border:0">
                                                <img src="source/image/product/{{$cart['item']['image']}}" height="120"
                                                    width="120" style="display:block;border:0px">
                                            </a>
                                        </td> -->
                                            ...
                                            <table style="width:100%" cellpadding="0" cellspacing="0" border="0">
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td align="left" valign="top"
                                                            style="font-family:Arial,Helvetica,sans-serif;font-size:12px;color:#666666;line-height:20px;padding-left:10px;padding-bottom:5px">
                                                            <b>{{$shipping_array['name']}}</b> -
                                                            {{$shipping_array['phone_number']}}
                                                            <br>
                                    ...
                                    <tr>
                                        <td align="center" valign="middle"
                                            ...
                                            <a href="{{route('lienhe')}}"
                                                ...
                                                target="_blank">
                                                daub1910508@student.ctu.edu.vn
                                            </a>
                                        </td>
                                    </tr>
                                </tbody>
