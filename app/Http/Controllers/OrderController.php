...
class OrderController extends Controller
{
    ...
    public function print_order_convert($checkout_code)
    {
        ...
        <div style="float: left; margin: 0 0 1.5em 0; ">
         <strong style="font-size: 18px;">VinChoice</strong>
          <br />
          <strong>Địa chỉ:</strong> Đại học Cần Thơ, Đường 3/2 phường An Khánh quận Ninh Kiều TP Cần THơ
          <br/>
          <strong>Điện thoại:</strong> 0945275090
          <br/>
          <strong>Website:</strong> VinChoice
          <br/>
          <strong>Email:</strong> daub1910508@student.ctu.edu.vn
        </div>
        ...
        <table style="margin: 0 0 1.5em 0;font-size: 12px;" width="100%">
          ...
          <tbody>';
        foreach ($billdetaill_print as $bd) {
            foreach ($bill_print as $b_print) {
                $totalPrice = $kh_print->payment == 'ATM' ? 0 : $b_print->total;
                $output .= '
        ...
        <table style="font-size: 12px;width: 100%; margin: 0 0 1.5em 0;">
          ...
          <tr>
            ...
            <td style="text-align:right;"><strong><p>' . number_format($totalPrice, 0, ',', '.') . ' VNĐ</td>
          </tr>
        </table>
        ...
        </td></tr></table><br/><br/><br/><p>Nếu bạn có thắc mắc, vui lòng liên hệ chúng tôi qua email <u>daub1910508@student.ctu.edu.vn</u> hoặc số điện thoại: 0945275090</p></div>
        ';
